...
const StickyPlayer = ({ playbackId, metadata, title, subtitle }) => {
    ...
    <>
      ...
      <div ref={containerRef} className="w-full">
        ...
        <div 
          ...
          className={`transition-all duration-300 ${
            isSticky && !isMinimized
              ? 'fixed bottom-20 md:bottom-24 right-3 md:right-6 z-50 w-[240px] md:w-[450px] lg:w-[550px] max-h-[135px] md:max-h-none shadow-2xl rounded-lg overflow-hidden'
              : 'relative w-full'
          }`}
        ...
        >
          ...
          {/* Información del video en modo sticky */}
          {isSticky && !isMinimized && title && (
